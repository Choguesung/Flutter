...
import 'package:swing/database/db_connection.dart';
    ...
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
            mypage(),
            PlayerInfoCard(player_name: '1',player_img: '1',player_id: '1',),
          ],
        ),
      ),
    );
...
class _mypageState extends State<mypage> {
  ...
  Future<void> connectToMySQL() async {
    ...
    // 쿼리 실행
    Results results = await conn.query('SELECT * FROM world');
